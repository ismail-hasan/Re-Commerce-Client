    ...
    return (
        <div className='lg:flex gap-10 my-10 mb-10 '>
            <div className='relative w-1/2'>
                ...
                <div className='absolute top-16 left-0 z-10 text-center'>
                    <h1 className='text-3xl capitalize'>New Arrivals</h1>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatibus ab fuga, aspernatur est rerum ipsa voluptate amet earum explicabo deleniti?</p>
                </div>
            </div>
            <div className='relative w-1/2'>
